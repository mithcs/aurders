...
use crate::pkgbuild::utils::{get_checksum, CHECKSUM_TYPE, SOURCES, SOURCES_COUNT};

const DELIMETER: &str = ",";

/// Gets maintainer name and return it
pub(super) fn get_maintainer_name_input() -> String {
...
pub(super) fn get_maintainer_email_input() -> String {
...
pub(super) fn get_pkgname_input() -> String {
...
pub(super) fn get_pkgver_input() -> String {
...
pub(super) fn get_pkgrel_input() -> String {
...
pub(super) fn get_epoch_input() -> String {
...
pub(super) fn get_pkgdesc_input() -> String {
...
pub(super) fn get_arch_input() -> Vec<String> {
...
pub(super) fn get_url_input() -> String {
...
pub(super) fn get_checksum_type_input() {
...
pub(super) fn get_checksums_input() -> Vec<String> {
    let mut checksums: Vec<String> = Vec::new();

    unsafe {
        // due to SOURCES, SOURCES_COUNT
...
pub(super) fn get_install_input() -> String {
...
pub(super) fn get_sources_input() -> Vec<String> {
...
pub(super) fn get_changelog_input() -> String {
...
pub(super) fn get_license_input() -> Vec<String> {
...
pub(super) fn get_depends_input() -> Vec<String> {
...
pub(super) fn get_makedepends_input() -> Vec<String> {
...
pub(super) fn get_checkdepends_input() -> Vec<String> {
...
pub(super) fn get_optdepends_input() -> Vec<String> {
...
pub(super) fn get_conflicts_input() -> Vec<String> {
...
pub(super) fn get_provides_input() -> Vec<String> {
...
/// Gets provides from user and returns it
pub(super) fn get_replaces_input() -> Vec<String> {
...
/// Gets options from user and returns it
pub(super) fn get_options_input() -> Vec<String> {
    let avail_options = vec![
        "strip",
        "docs",
        "libtool",
        "staticlibs",
    ...
    let options = MultiSelect::new("Select option(s) to override", avail_options)
        .with_page_size(5)
        .with_vim_mode(true)
...
pub(super) fn get_backup_input() -> Vec<String> {
...
pub(super) fn get_prepare_input() -> Vec<String> {
...
pub(super) fn get_build_input() -> Vec<String> {
...
pub(super) fn get_check_input() -> Vec<String> {
...
pub(super) fn get_package_input() -> Vec<String> {
